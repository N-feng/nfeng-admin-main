...
export const routesConfig: RouteConfigDeclaration[] = [
        ...
        routes: [
            {
                ...
                isDynamic: true,
                component: React.lazy(() =>
                    import(/* webpackChunkName: "child-one" */ '../views/home/ChildOne'),
                ),
            },
            {
                path: '/home/child-two',
                ...
                isDynamic: true,
                component: React.lazy(() =>
                    import(/* webpackChunkName: "child-two" */ '../views/home/ChildTwo'),
                ),
            }
        ],
    },
    ...
    //     path: '*',
    //     isDynamic: true,
    //     component: React.lazy(() => import('../views/404/NotFound'))
    // }
]